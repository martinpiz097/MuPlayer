...
import org.audio.audio.track.state.*;
import org.jaudiotagger.tag.FieldKey;
import cl.estencia.labs.muplayer.muplayer.audio.info.AudioTag;
import cl.estencia.labs.muplayer.muplayer.audio.player.AudioComponent;
import cl.estencia.labs.muplayer.muplayer.audio.player.Player;
import org.muplayer.audio.track.state.*;
import cl.estencia.labs.muplayer.muplayer.interfaces.ControllableMusic;
import cl.estencia.labs.muplayer.muplayer.interfaces.ReportableTrack;
import cl.estencia.labs.muplayer.muplayer.model.MuPlayerAudioFormat;
import cl.estencia.labs.muplayer.muplayer.audio.io.AudioIO;
...
import static cl.estencia.labs.muplayer.muplayer.audio.values.AudioConstantValues.DEFAULT_MAX_VOL;
import static cl.estencia.labs.muplayer.muplayer.audio.values.AudioConstantValues.DEFAULT_MIN_VOL;
...
public abstract class Track extends AudioComponent implements Runnable, ControllableMusic, ReportableTrack {
    ...
    public void unMute() {
        if (trackStatusData.isVolumeZero()) {
            ...
            if (trackIO != null && trackIO.isTrackStreamsOpened()) {
                trackIO.setGain(audioUtil.convertVolRangeToLineRange(trackStatusData.getVolume()));
            }
        } else {
