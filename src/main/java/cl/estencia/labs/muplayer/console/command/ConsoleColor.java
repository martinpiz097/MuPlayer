...
public class ConsoleColor {
    ...
    public static final String INFO_LEVEL_COLOR = ANSI_GREEN;
    public static final String WARN_LEVEL_COLOR = ANSI_YELLOW;
    public static final String ERROR_LEVEL_COLOR = ANSI_RED;
    public static final String RAW_LEVEL_COLOR = ANSI_WHITE;
    public static final String RESET_COLOR = ANSI_RESET;

//    public static void main(String[] args) {
//        System.out.println(
//                "\033[31m" +      // foreground rojo
//                        "\033[47m" +      // background blanco
