package cl.estencia.labs.muplayer.data.json.command;

import com.fasterxml.jackson.core.type.TypeReference;
import lombok.Getter;
import cl.estencia.labs.muplayer.console.ConsoleOrderCode;
import cl.estencia.labs.muplayer.data.json.JsonInfo;
import cl.estencia.labs.muplayer.data.json.InternalJsonSource;
import cl.estencia.labs.muplayer.data.json.command.model.ConsoleCodeResult;
import cl.estencia.labs.muplayer.data.json.command.model.ConsoleCodesData;

import java.util.LinkedList;

import static cl.estencia.labs.muplayer.data.properties.ResourceFiles.CONSOLE_PLAYER_CODES_RES_PATH;
